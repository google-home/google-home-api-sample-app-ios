...
public class AutomationCreationViewModel {
  private let automationList: AutomationList
  /// The automation to be created
  private let draftAutomation: any DraftAutomation
  ...
  public init(automationList: AutomationList, draftAutomation: any DraftAutomation) {
    ...
    self.automationModel = AutomationUIDataModel(draftAutomation: draftAutomation)
  }
